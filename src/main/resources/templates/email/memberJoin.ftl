...
<article style="width: 725px; border-top: 7px solid #37afe5;">
    <section style="padding: 30px; box-sizing: border-box;">
        <div style="display: inline-block;">
            ...
            <span style="color: #909090; font-size: 18px;"><strong style="color: #37afe5;">${userInfo.name}</strong>님의 회원가입이 완료되었습니다.</span>
        </div>
    ...
    <section style="padding: 30px; box-sizing: border-box; margin: 40px 0;">
        ...
        <p style="font-size: 14px; padding-top: 15px;">
            가입 시 등록하신 비밀번호 변경을 원하시면<br />로그인 > 마이페이지 > 비밀번호 변경에서 언제든지 수정하실 수 있습니다.
        </p>
    </section>
