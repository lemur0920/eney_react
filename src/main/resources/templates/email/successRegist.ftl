...
<article style="width: 725px; border-top: 7px solid #37afe5;">
    <section style="padding: 30px; box-sizing: border-box;">
        <div style="display: inline-block;">
            ...
            <h1 style="font-size: 36px; letter-spacing: -1.5px; margin: 14px 0 40px 0; line-height: 1.4;">주식회사 에네이 입니다<br />환영합니다!</h1>
            <span style="color: #909090;"><strong style="color: #37afe5;">${userInfo.name}</strong>님 서비스를 신청해주셔서 감사합니다.</span>
        </div>
    ...
    <section style="padding: 30px; box-sizing: border-box; margin: 40px 0;">
        <table style="border-collapse: collapse; width: 100%;">
            ...
            <tr style="border-top: 1px solid #e6e6e6;">
                <th style="border-right: 1px solid #e6e6e6; background-color: #fafafa; padding: 10px 0; font-size: 14px;">이름</th>
                <td style="text-align: center; font-size: 14px;">${userInfo.name}</td>
            </tr>
        ...
        <p style="font-size: 14px; padding-top: 15px;">
            신청하신 정보는 마이페이지에서 확인 가능합니다. 감사합니다.
            <a style="color:#37afe5;" href="https://www.eney.co.kr" target="_blank">에네이 바로가기</a>
        </p>
    </section>
